...
const hoverItemClasses =
  'block w-full px-4 py-2 cursor-pointer hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-700 dark:hover:bg-gray-600 dark:focus:ring-gray-500';
