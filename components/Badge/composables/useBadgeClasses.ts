...
export function useBadgeClasses(props: UseBadgeClassesProps, options: UseBadgeClassesOptions): {
    ...
    const badgeClasses = computed<string>(() => {
        ...
        const typeClasses = props.outline.value ? badgeOutlineTypeClasses[props.type.value] : badgeTypeClasses[props.type.value]
        const textClasses = props.outline.value ? badgeOutlineTextClasses[props.type.value] : badgeTextClasses[props.type.value]
